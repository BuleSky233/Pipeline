...
def IDK_fm_cycle(X, t, psi, width):
...
def IDK_GDK(X,cycle,t,psi,components,gamma):
    feature_map_subsequence = IDK_fm_cycle(X,t=t,psi=psi,width=cycle)
    return GDK(X=feature_map_subsequence,gamma=gamma,components=components)
