...
from IDK import IDK
from IK_fm import IK_fm


def IDK_sub(X, t, psi,width,psi2=None):
    ...
    if psi2 is None:
        ...
        for i in range(7):
            ...
            if p > (int)(X.shape[0]/width):
                break

            score_of_windows.append(IK_fm(featuremap_count, t, p))
    else:
        score_of_windows.append(IK_fm(featuremap_count, t, psi2))
